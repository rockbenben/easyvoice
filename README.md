...
- **完整大包**：下载 `EasyVoice-v1.0.zip.01/.02/.03` + `merge-and-extract.bat` 到同一文件夹，双击 bat 自动合并解压。
- **CPU 精简包**：下载单个 `EasyVoice-v1.0-cpu.zip`，解压即用。⚠️ **CPU 生成较慢**：约每句 20–40 秒（视机器）、长段落数分钟，适合短句/预览。有 N 卡求速度请用完整大包。
